        ...
        void Update()
        {
            ...
            switch (currentTypingState)
            {
                ...
                case TypingState.Setup: //setup the line that needs to be displayed
                    ...
                    {
                        currentLine =
                            "Hey there NAME. Let's get to work ok? I need you to make sure I receive emails from work and my family. If you think some are important, tag them as such. Anything you think is not relevant to me, you can just delete. \n Oky Thanks :)";
                        currentLine = currentLine.Replace("NAME", NAME.GetPlayerName());
                    }
                ...
                case TypingState.Typing: //when the text needs to be displayed letter by letter
                    if (currentLetterIndex < currentLine.Length && currentLetterIndex != stopIndex &&
                        getStateElapsed() > waitTime)
                    {
